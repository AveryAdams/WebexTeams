...
setup(
        name = 'WebexTeams',
        version = '0.1',
        packages = ['venv.Lib.site-packages.idna',
                    ...
                    'venv.Lib.site-packages.pip-9.0.1-py3.6.egg.pip',
        ...
        license = 'None',
        author = 'Avery Adams',
        author_email = 'avery.adams@gmail.com',
        description = 'Some Webex Teams Tools'
)
